...
def create_revenue_chart():
    ...
    revenue = [608, 635, 704, 741, 653, 815, 776]
    # PAT in Cr
...
def build_pdf(chart_paths):
    ...
    story.append(Paragraph(
        ...
        '(+466 bps YoY), driven by favorable raw material prices. Gross margin remains stable '
    ...
    story.append(Paragraph(
        'Bikaji\'s stock has seen significant volatility over the past 12 months, trading between '
        '₹558.80 (52-week low) and ₹818.70 (52-week high, per NSE/Kotak/Tickertape). The Jan 29 '
        'close of ₹660 sits at ~39% of the 52-week range, suggesting the stock is in a corrective '
    ...
    tech_data = [
        ...
        ['Resistance Zone', '₹818–864', 'Previous highs, needs volume to break'],
    ]
    ...
    story.append(Paragraph(
        ...
        'Accounting quality concerns (30% cash conversion) and the looming Haldiram\'s IPO add uncertainty.',
        body_style
    ))
    ...
    eps_data = [
        ...
        ['Shares Outstanding', '~25.06 Cr', 'Market Cap ÷ Price'],
    ...
    prob_points = [
        ...
        'is already weak at 30%, (b) commodity reversal is possible given Indonesia CPO supply risks, '
    ...
    story.append(Paragraph(
        '<b>Probability-weighted expected price: ₹763</b> — implying ~15.6% upside from ₹660. '
    ...
    limit_points = [
        ...
        '<b>P/E assumptions are subjective:</b> The choice of 50-55x for base vs 40-45x for bear is '
        ...
        '<b>Cash flow ignored in valuation:</b> Given the 30% cash conversion ratio flagged earlier, '
    ...
    story.append(Paragraph(
        'The <b>probability-weighted expected value of ₹763 implies ~15.6% upside</b> over 12 months. '
    ...
    story.append(Paragraph(
        '<b>On balance, the stock offers a moderate expected return (~16%) with asymmetric risk '
